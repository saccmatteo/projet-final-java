...
INSERT INTO product (label, price, nb_in_stock, min_treshold, is_gluten_free, alcohol_percentage, distribution_date, last_restock_date, description, category_label, supplier_label) VALUES
-- Boisson alcoolisée
...
INSERT INTO `order` (order_date, payment_date, discount_percentage, `comment`, is_happy_hour, status_label, user_id, payment_method_label) VALUES
('2025-04-01', '2025-04-01', 0, 'RAS', FALSE, 'En cours', 1, 'Carte Bancaire'),
('2025-04-01', '2025-04-01', 10, '', TRUE, 'En cours', 2, 'Espèces'),
('2025-04-02', '2025-04-02', 5, 'Client fidèle', FALSE, 'En cours', 1, 'Ticket Restaurant'),
